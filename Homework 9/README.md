...
debugging switching from my old code to using sprites was a bit overwhelming. I also spent time adjusting things like obstacles, borders, and visuals so the game felt more like my original idea.
 ...
 I used examples from the class lessons as a reference like sprites, animations, and collision set up. I used ChatGPT to help debug issues and understand how to use p5.play. This included fixing problem
 with sprite movement, collisions, and getting the game over logic to work correctly.
